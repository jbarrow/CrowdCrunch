...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.current_job'
        db.alter_column(u'cruncher_userprofile', 'current_job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cruncher.Job'], null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.current_job'
        db.alter_column(u'cruncher_userprofile', 'current_job_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cruncher.Job']))
