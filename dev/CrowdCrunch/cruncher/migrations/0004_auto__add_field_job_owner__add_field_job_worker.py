...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cruncher_job', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='owned_jobs', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Job.worker'
        db.add_column(u'cruncher_job', 'worker',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='worked_jobs', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.owner'
        db.delete_column(u'cruncher_job', 'owner_id')

        # Deleting field 'Job.worker'
        db.delete_column(u'cruncher_job', 'worker_id')
    ...
    models = {
        ...
        u'cruncher.job': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_jobs'", 'to': u"orm['auth.User']"}),
            'rating': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'status': ('django.db.models.fields.IntegerField', [], {}),
            'worker': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'worked_jobs'", 'to': u"orm['auth.User']"})
        },
        u'cruncher.payment': {
