...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.user_id'
        db.add_column(u'cruncher_userprofile', 'user_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', blank=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'UserProfile.phone_number'
        db.add_column(u'cruncher_userprofile', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.user_id'
        db.delete_column(u'cruncher_userprofile', 'user_id_id')

        # Deleting field 'UserProfile.phone_number'
        db.delete_column(u'cruncher_userprofile', 'phone_number')
