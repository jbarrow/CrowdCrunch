...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Communication.timestamp'
        db.add_column(u'cruncher_communication', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Communication.timestamp'
        db.delete_column(u'cruncher_communication', 'timestamp')
